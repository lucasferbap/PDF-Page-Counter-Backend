...
var pdf_parser_1 = __importDefault(require("./pdf-parser"));
...
app.get('/', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, pdf_parser_1.default)()];
            case 1:
                res = _a.sent();
                return [2 /*return*/, response.status(200).send(res)];
            case 2:
                error_1 = _a.sent();
                return [2 /*return*/, response.status(200).send(error_1)];
            case 3: return [2 /*return*/];
        }
    });
}); });
app.post('/', upload.array('file'), function (request, response) {
